...
def run(**kwargs):
    ...
    crypto_data.regist_double_sma_strategy(strategy_id_2, timeframe_2, interval_2, slen_2, crypto_data.handle_15m_kline)
    crypto_data.regist_double_sma_strategy(strategy_id_3, timeframe_3, interval_3, slen_3, crypto_data.handle_15m_kline)
